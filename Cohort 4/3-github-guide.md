...
For each new week of assignments, create a new branch named `cohort-4-week-#` (replace # with the current week number):

```bash
git checkout -b cohort-4-week-#
```
...
git push -u origin cohort-4-week-#
```
...
- **Base Branch**: main  
- **Head Repository**: your-github-account/studygroup  
- **Head Branch**: cohort-4-week-# 

For the title, use this template: `YOUR-NAME: Cohort 4 Week #`.
