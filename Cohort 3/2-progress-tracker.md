...
|------------------------------------------------------|------|-------|-----------------|---------|
| [WiEP Study Group Fellow](https://github.com/example)| Week 5 Day 5 | [Besu #3787](https://github.com/hyperledger/besu/issues/3787)  | Discussed the issue on GitHub and started writing code. |[#47](https://github.com/wiepteam/studygroup/pull/47) &#x2705;         |
...
|  Koko    |         |        |         |         |
| [Lada](https://github.com/hara-desu)             | Week 5        | [consensus-specs #4136](https://github.com/ethereum/consensus-specs/issues/4136), [Lodestar #6991](https://github.com/ChainSafe/lodestar/issues/6991)       | Asked if I can be assigned issue 6991 and started working on it.       | Was assigned the issue 6991.   |
