...
|  [Barakat](https://github.com/baraqheart)                | Week 10     | [Prysm #13721](https://github.com/OffchainLabs/prysm/issues/13721)      | Created a PR and awaiting reviews               |     🛠    |
...
|  [Mercy](https://github.com/bomanaps)      |    Week 9     |  [Lodestar #5902](https://github.com/ChainSafe/lodestar/issues/5902), [Lodestar #6724](https://github.com/ChainSafe/lodestar/pull/6724)     | I have merged the loops for `getAllAncestorNodes` and `getAllNonAncestorNodes` into a single loop. The remaining task is to review the changes before proceeding with `archive.ts` this issue is currently onhold due to some implications around it.       |     [Lodestar #7692](https://github.com/ChainSafe/lodestar/pull/7692) ✅, [Lodestar #7528](https://github.com/ChainSafe/lodestar/pull/7528)🚀    |
